...
public class bossScript2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (gunCooldownTimer <= 0)
        {
            ...
            {
                //spawn bullets
                Instantiate(bullets[1], gunPorts[2].position, gunPorts[2].rotation);
                Instantiate(bullets[1], gunPorts[3].position, gunPorts[3].rotation);
                Instantiate(bullets[1], gunPorts[4].position, gunPorts[4].rotation);
                Instantiate(bullets[1], gunPorts[5].position, gunPorts[5].rotation);
                //reset timer
                gCounter = 0;
            }
            //reset timer
